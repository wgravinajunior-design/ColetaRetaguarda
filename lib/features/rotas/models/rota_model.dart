class RotaModel {
  ...
  factory RotaModel.fromJson(Map<String, dynamic> json) {
    return RotaModel(
      ...
      dataPrevista: json['ROT_DATA_PREVISTA'] != null
          ? DateTime.tryParse(json['ROT_DATA_PREVISTA'] as String)
          : null,
      dataInicio: json['ROT_DATA_INICIO'] != null
          ? DateTime.tryParse(json['ROT_DATA_INICIO'] as String)
          : null,
      dataFim: json['ROT_DATA_FIM'] != null
          ? DateTime.tryParse(json['ROT_DATA_FIM'] as String)
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'ROT_STATUS': status,
      'ROT_DATA_PREVISTA': dataPrevista?.toIso8601String(),
      'ROT_DATA_INICIO': dataInicio?.toIso8601String(),
      'ROT_DATA_FIM': dataFim?.toIso8601String(),
      'ROT_PARADAS': paradas,
